...
class KITTI(data.Dataset):
        ...
        for dc in self.dataset_categories:
            ...
            for s in samples:
                file_list.append({
                    ...
                    'model_id': s,
                    'partial_cloud_path': os.path.join(self.cloud_path, s),
                    'bounding_box_path': os.path.join(self.bbox_path, s),
                })
        return file_list
    ...
    def __getitem__(self, idx):
        ...
        for ri in ['partial_cloud', 'bounding_box']:
            if ri == 'partial_cloud':
                file_path = sample[f'{ri}_path']+".pcd"
            elif ri == 'bounding_box':
                file_path = sample[f'{ri}_path']+".txt"
        ...
        return  sample['taxonomy_id'], sample['model_id'], Data(pos=data['partial_cloud']), data['partial_cloud'], sample['partial_cloud_path']
